...
Script to test CFpRF on empirical data.
"""
...
def run(root="/project/2420084.01", subject=0):
    ...
    # Save results
    np.savez(os.path.join(root, "derivatives", "cfprf", "results_empirical_{}.npz".format(train_dataset.subject)), 
...
if __name__ == "__main__":
    ...
    for i_subject in range(n_subjects):
        run(root=root, subject=i_subject)
